...
/**
 * 
 * This class creates a bash script for Iptables which deletes a Mangle rule
 ...
 * 
 */
public class deleteMangleRule implements Runnable
{
//Retrieve user data
	String num = iptables.mangleNum.getText();
//Start thread
public void run()
{
//Create script
...
iptables.textArea.setText("Mangle Rule Deleted");
