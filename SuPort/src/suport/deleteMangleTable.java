...
/**
 * 
 * This class creates a bash script for Iptables which deletes the Mangle table
 ...
 * 
 */
public class deleteMangleTable implements Runnable
{
//Start thread
public void run()
{
...
iptables.textArea.setText("Mangle Table Deleted");
