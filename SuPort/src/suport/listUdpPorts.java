...
/**
 * 
 * This class has a bash script that calls Netstat to list the UDP ports and print out the result
 ...
 * 
 */
public class listUdpPorts implements Runnable
{
static String line = " ";
...
try
{
	...
	try 
	{
		in = new Scanner(new File("listudpports"));
		in.useDelimiter(System.getProperty("line.separator"));
		br = new BufferedReader(new FileReader("listudpports"));
	} 
