...
/**
 * 
 * This class has a bash script that calls Netstat to list the sockets and print out the result
 ...
 * 
 */
public class listSockets implements Runnable
{
static String line = " ";
//Start thread
public void run()
...
try
{
	...
	Scanner in = null;
	try {
		in = new Scanner(new File("listsockets"));
	in.useDelimiter(System.getProperty("line.separator"));
	br = new BufferedReader(new FileReader("listsockets"));
	} 
