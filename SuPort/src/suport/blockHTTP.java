...
/**
 * 
 * This class has a bash script that calls Iptables to block HTTP
 ...
 * 
 */
public class blockHTTP implements Runnable
{
	//Retrieve user input
	String ethNum= iptables.blockHTTPtf.getText();
	String ip= iptables.blockHTTPtf2.getText();
...
"/bin/sh",
"-c",
"iptables -A FORWARD -p tcp -i " + ethNum+ " -s ! " + ip + " --dport 80 -j REJECT"
...
iptables.textArea.setText("Block HTTP Traffic Rule Applied");
