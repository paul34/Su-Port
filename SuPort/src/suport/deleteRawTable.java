...
/**
 * 
 * This class creates a bash script for Iptables which deletes the Raw table
 ...
 * 
 */
public class deleteRawTable implements Runnable
{
//Start thread
public void run()
{
...
iptables.textArea.setText("Raw Table Deleted");
