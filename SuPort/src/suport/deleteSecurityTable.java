...
/**
 * 
 * This class creates a bash script for Iptables which deletes the Security table
 ...
 * 
 */
public class deleteSecurityTable implements Runnable
{
//Start thread
public void run()
{
...
iptables.textArea.setText("Security Table Deleted");
