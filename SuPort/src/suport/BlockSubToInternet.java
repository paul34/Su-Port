...
/**
 * 
 * This class has a bash script that calls Iptables to block online activity from a subnet
 ...
 * 
 */
public class BlockSubToInternet implements Runnable
{
	//Retrieve user input
	String ethNum= iptables.BlockSubEth1.getText();
	String ethNum2= iptables.BlockSubEth2.getText();
	String ipNum= iptables.BlockSubIP1.getText();
	String ipNum2= iptables.BlockSubIP2.getText();
//Start thread
public void run()
{
//Create scripts
...
"/bin/sh",
"-c",
"iptables -A FORWARD -i "+ethNum+" -o " +ethNum2+" -j REJECT"
...
iptables.textArea.setText("Subnet Blocked to Internet Rule Applied");
