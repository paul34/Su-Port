...
/**
 * 
 * This class has a bash script that calls Netstat to list all ports and print out the result
 ...
 * 
 */
public class listAllPorts implements Runnable
{
static String line = " ";
//Start thread
public void run()
...
try
{
	...
	try 
	{
	in = new Scanner(new File("listnetports"));
	in.useDelimiter(System.getProperty("line.separator"));
	br = new BufferedReader(new FileReader("listnetports"));
	} 
