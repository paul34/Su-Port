...
/**
 * 
 * This class creates a bash script for Iptables which deletes the Nat rule
 ...
 * 
 */
public class deleteNatTable implements Runnable
{
...
"-c",
 "iptables -t nat -X"
	...
	iptables.textArea.setText("Nat Table Deleted");
