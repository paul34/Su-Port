...
/**
 * 
 * This class creates a bash script for Iptables which checks the General Rules table and prints out to file
 ...
 * 
 */
public class checkAllRules implements Runnable
{
	static String line = " ";
//Start thread
public void run()
...
try
{
	...
	Scanner in = null;
	try {
		in = new Scanner(new File("allRules"));
		in.useDelimiter(System.getProperty("line.separator"));
		br = new BufferedReader(new FileReader("allRules"));
	} 
