...
/**
 * 
 * This class creates a bash script for Tcpdump which displays the interfaces
 ...
 * 
 */
public class displayInterfaces implements Runnable
{
static String line = " ";
//Start thread
public void run()
...
try
{
	...
	try 
	{
		in = new Scanner(new File("interfaces"));
		in.useDelimiter(System.getProperty("line.separator"));
		br = new BufferedReader(new FileReader("interfaces"));
	} 
