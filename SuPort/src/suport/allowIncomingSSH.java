...
/**
 * 
 * This class has a bash script that calls Iptables to allow SSH in to the home computer
 ...
 * 
 */
public class allowIncomingSSH implements Runnable
{
	//Retrieve user data
	String ethNum= iptables.allowSSHtf.getText();
//Start thread
public void run()
{
//Create scripts
...
"/bin/sh",
"-c",
"iptables -A INPUT -i " + ethNum + " -p tcp --dport 22 -m state --state NEW,ESTABLISHED -j ACCEPT"
...
iptables.textArea.setText("Allow Incoming SSH Rule Applied");
