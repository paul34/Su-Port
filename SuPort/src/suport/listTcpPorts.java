...
/**
 * 
 * This class has a bash script that calls Netstat to list the TCP ports and print out the result
 ...
 * 
 */
public class listTcpPorts implements Runnable
{
static String line = " ";	
...
try
{
	...
	Scanner in = null;
	try {
		in = new Scanner(new File("listtcpports"));
		in.useDelimiter(System.getProperty("line.separator"));
		br = new BufferedReader(new FileReader("listtcpports"));
	} 
