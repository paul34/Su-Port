...
/**
 * 
 * This class creates a bash script for Iptables which checks the Filter table and prints out to file
 ...
 * 
 */
public class checkFilterRules implements Runnable
{
	static String line = " ";
...
"/bin/sh",
"-c",
"iptables -t filter -vL > filterRules"
};
...
try
{
	...
	try 
	{
	in = new Scanner(new File("filterRules"));
	in.useDelimiter(System.getProperty("line.separator"));
	br = new BufferedReader(new FileReader("filterRules"));
	} 
