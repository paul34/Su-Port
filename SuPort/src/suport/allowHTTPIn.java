 ...
 * 
 */
public class allowHTTPIn implements Runnable
{
	//Retrieve user data
	String ethNum= iptables.HTTPtf.getText();
//Start thread
public void run()
{
//Create scripts
...
"/bin/sh",
"-c",
"iptables -A INPUT -i " + ethNum + " -p tcp --dport 80 -m state --state NEW,ESTABLISHED -j ACCEPT"
};
...
iptables.textArea.setText("Allow HTTP Inbound Rule Applied");
