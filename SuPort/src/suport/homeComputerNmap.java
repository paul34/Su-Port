...
/**
 * 
 * This class creates a bash script for Nmap which checks for the basic open ports 
 ...
 */
public class homeComputerNmap implements Runnable
{
	//Retrieve user input
	String ipInput = iptables.ipNmap.getText();
