...
/**
 * 
 * This class has a bash script that calls Iptables to allow pings to the home computer
 ...
 * 
 */
public class allowPingsOut implements Runnable
{
//Start thread
public void run()
{
...
iptables.textArea.setText("Allow Pings Out Rule Applied");
