...
/**
 * 
 * This class has a bash script that calls Iptables to allow SSH traffic out from the home computer
 ...
 * 
 */
public class allowOutgoingSSH implements Runnable
{
	//Retrieve user data
	String ethNum= iptables.allowSSHOut.getText();
//Start thread
public void run()
{
//Create scripts
...
"/bin/sh",
"-c",
"iptables -A OUTPUT -o " + ethNum + " -p tcp --dport 22 -m state --state NEW,ESTABLISHED -j ACCEPT"
...
iptables.textArea.setText("Allow Outgoing SSH Rule Applied");
