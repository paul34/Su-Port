...
/**
 * 
 * This class has a bash script that calls Iptables to allow HTTPS traffic in to the home computer
 ...
 */
public class allowHTTPSIn implements Runnable
{
	//Retrieve user input
	String ethNum= iptables.HTTPSIntf.getText();
//Start thread
public void run()
{
//Create scripts
...
"/bin/sh",
"-c",
"iptables -A INPUT -i " + ethNum + " -p tcp --dport 443 -m state --state NEW,ESTABLISHED -j ACCEPT"
...
"/bin/sh",
"-c",
"iptables -A OUTPUT -o " + ethNum + " -p tcp --sport 443 -m state --state ESTABLISHED -j ACCEPT"
...
iptables.textArea.setText("Allow HTTPS Inbound Rule Applied");
