...
/**
 * 
 * This class creates a bash script for Nmap which checks for all open ports 
 ...
 */
public class groupNmapAllPorts implements Runnable
{
	//Retrieve user data
	String ipInput = iptables.ipNmapGroupPorts.getText();
//Start thread
public void run()
{
	...
	dialog.setTitle("Please Wait... All Ports may take a While");
	dialog.add(label);
	dialog.pack();
...
"/bin/sh",
"-c",
"nmap" + " -p-" + " " + ipInput + " > nmapresultAllPorts"
};
...
try
{
	...
	Scanner in = null;
	try {
		in = new Scanner(new File("nmapresultAllPorts"));
		in.useDelimiter(System.getProperty("line.separator"));
		br = new BufferedReader(new FileReader("nmapresultAllPorts"));
		} 
